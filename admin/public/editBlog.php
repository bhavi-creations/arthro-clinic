...
<head>
    ...
    <title>Arthro 360 - Dashboard</title>
                                    ...
                                    <form style='color:black;' id="addblogform" action="addBlog.php" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label text-primary">ENTER
                                                TITLE</label>
                                            <input type="TEXT" class="form-control text-grey-900" id="exampleFormControlInput1" value="<?php echo htmlspecialchars($title); ?>" placeholder="TITLE" name="title">
                                        </div>
