<ul class="navbar-nav   sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #234f6e">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center  bg-light text-primary" href="./index.php">
        ...
        <div class="sidebar-brand-text mx-3">Arthro </div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
            ...
            <i class="fas fa-fw fa-blog" style="color: black;"></i>
            <span class="Dashboard">BLOGS</span>
        </a>
